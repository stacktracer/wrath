...
- Keyboard navigation audit — verify focus rings are visible and styled intentionally, not just browser defaults
- Theming approach — decide on CSS custom properties vs. utility classes vs. something else; this is a key architectural question for direct styling
